...
import ruilelin.com.shifenlife.map.SearchResultAdapter;
import ruilelin.com.shifenlife.map.SegmentedGroup;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.d("ceshi","task2=="+task2);
                if("Choose_poi".equals(task2)) {
                    Intent intent = new Intent();
                    //intent.putExtra("poiItem", bindpoiItem);
                    Bundle bundle = new Bundle();
                    bundle.putParcelable("poiItem", bindpoiItem);
    ...
    AdapterView.OnItemClickListener onItemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            if (position != searchResultAdapter.getSelectedPosition()) {
                ...
                isChoose = true;
                Log.d("gaode","poiItem=="+poiItem);
                Log.d("gaode","getLatitude=="+poiItem.getLatLonPoint().getLatitude());
                Log.d("gaode","getLongitude=="+poiItem.getLatLonPoint().getLongitude());
                bindpoiItem = poiItem;
                aMap.moveCamera(CameraUpdateFactory.newLatLngZoom(curLatlng, 16f));
    ...
    Inputtips.InputtipsListener inputtipsListener = new Inputtips.InputtipsListener() {
        ...
        public void onGetInputtips(List<Tip> list, int rCode) {
            if (rCode == AMapException.CODE_AMAP_SUCCESS) {// 正确返回
                ...
                Toast.makeText(GaodeActivity.this, "erroCode " + rCode , Toast.LENGTH_SHORT).show();
            }
        }
    };
