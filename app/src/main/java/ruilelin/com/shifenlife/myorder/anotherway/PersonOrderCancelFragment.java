...
public class PersonOrderCancelFragment extends BaseFragment4 {
    ...
    //统一的Fragment构建方法
    public static PersonOrderCancelFragment newInstance(int flag) {
        Bundle args = new Bundle();
        //type代表页签，0：全部订单 1：待发货 2：待收货 3：已完成
        args.putString("type", String.valueOf(flag));
        Log.d("order1","flag=="+flag);
        current = flag;
        PersonOrderCancelFragment fragment = new PersonOrderCancelFragment();
    ...
    protected void initData() {
        ...
        RequestOrder requestOrder = new RequestOrder("CANCEL");
                            ...
                            getActivity().runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    if (resCode == Constant.SUCCESSCODE) {
                                        ...
                                        }else if((obj.getData()==null) || obj.getData().size()==0){
