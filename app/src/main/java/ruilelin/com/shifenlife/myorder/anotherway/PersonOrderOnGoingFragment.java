...
public class PersonOrderOnGoingFragment extends BaseFragment4 {
    ...
    //统一的Fragment构建方法
    public static PersonOrderOnGoingFragment newInstance(int flag) {
        Bundle args = new Bundle();
        //type代表页签，0：全部订单 1：待发货 2：待收货 3：已完成
        args.putString("type", String.valueOf(flag));
        Log.d("order1","flag=="+flag);
        current = flag;
        PersonOrderOnGoingFragment fragment = new PersonOrderOnGoingFragment();
    ...
    protected void initData() {
        ...
        mMyOkhttp.get()
                ...
                .url(Constant.SFSHURL+Constant.Handling+page+"/"+size)
                ...
                .enqueue(new JsonResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, JSONObject response) {
                      ...
                      int  resCodeOrder = obj.getCode();
                        if(getActivity()!=null) {
                            getActivity().runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    if (resCodeOrder == Constant.SUCCESSCODE) {
