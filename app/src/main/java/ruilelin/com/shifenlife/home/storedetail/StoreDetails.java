    ...
    TouchDelegate mDelegate = new TouchDelegate() {
        ...
        void onTouchDone(View view,TouchOrientation orientation,float offset) {
            if (orientation == TouchOrientation.DOWN_2_UP) {//往上
                int topMargin = Tools.px2dip(StoreDetails.this,mListsParams.topMargin);
                int configToolBarHeight = Tools.px2dip(StoreDetails.this,getResources().getDimension(R.dimen.toolbar_height));
...
//                    mLists.requestLayout();
                ...
                int topMargin = Tools.px2dip(StoreDetails.this,mListsParams.topMargin);
                int configTopMargin = Tools.px2dip(StoreDetails.this,getResources().getDimension(R.dimen.top_margin));
                float configTopMarginPx = getResources().getDimension(R.dimen.top_margin);
