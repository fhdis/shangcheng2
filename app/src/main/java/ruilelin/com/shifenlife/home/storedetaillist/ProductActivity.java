...
public class ProductActivity extends AppCompatActivity  implements SectionIndexer, View.OnClickListener {
    ...
    private void initData() {
        mProductList = Parser.getCateProductList(this);
        rightAdapter = new RightAdapter(this, mProductList);
        leftAdapter = new LeftAdapter(this, mProductList);
...
//        }
    ...
    private ViewGroup createAnimLayout() {
        ...
        LinearLayout animLayout = new LinearLayout(ProductActivity.this);
    ...
    private void initPopWindow() {
        ...
        View contentView = LayoutInflater.from(this).inflate(R.layout.popu_cart, null);
        int height = Utils.getScreenHeight(this) - (cartFrame.getHeight()*2) + 10;
        popupWindow = new PopupWindow(contentView, Utils.getScreenWidth(this),
                height);
        ...
        clearView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                UIHelper.clearCart(ProductActivity.this, businessId);
                cartFrame.setEnabled(false);
                popupWindow.dismiss();
...
//        popupWindow.setOnDismissListener();
    ...
    private void getCart(ListView listView) {
        mCartList = UIHelper.getCartList(this, businessId);
    ...
    private void updateCart(Product mProduct) {
        ...
        cart.setPrice(price);
        UIHelper.getQueryIdCart(this, cart, productId,businessId);
    }

    private void deleteProductId(int productId) {
        UIHelper.deleteCart(this, productId);
    }
    ...
    class RightAdapter extends BaseAdapter implements SectionIndexer {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            int salecount = UIHelper.saleCount(ProductActivity.this, mProduct.getProductId(), businessId);
            if (salecount > 0) {
    ...
    class CartAdapter extends BaseAdapter {
        ...
        private void deleteData() {
            try {
                mCartList = UIHelper.getCartList(ProductActivity.this, businessId);
                popuListView.setAdapter(new CartAdapter(ProductActivity.this, mCartList));
                rightAdapter.notifyDataSetChanged();
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        private void updateCart(Cart mCart) {
            ...
            UIHelper.getQueryIdCart(ProductActivity.this, cart, productId,businessId);
        }
