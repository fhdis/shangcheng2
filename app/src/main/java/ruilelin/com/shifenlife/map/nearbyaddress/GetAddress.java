package ruilelin.com.shifenlife.map.nearbyaddress;
...
public class GetAddress extends AppCompatActivity implements LocateRecyclerAdapter.OnLocationItemClick, AMapLocationListener, PoiSearch.OnPoiSearchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLocateCancel  = (TextView)findViewById(R.id.locate_cancel);
        mLocateRefresh = (TextView)findViewById(R.id.locate_refresh);
        initLocate();
        mList = new ArrayList<>();
